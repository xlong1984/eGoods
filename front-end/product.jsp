...
<body style="text-align: center">
	...
	<%
		...
		pp = (Products)request.getAttribute("product_info");
		
		String pname = pp.getProduct_name();
		ProductService ps = new ProductService();
		Products p = new Products();
		p = ps.findProductbyName(pname);
            ...
            <h1 style="text-align:left; border-bottom:solid #F6F6F6;" ><%=p.getProduct_name() %></h1>
                <table style="width: 100%; margin-top:20px; margin-bottom:20px;">
                    ...
                    <tr>
                        ...
                        <td class="auto-style15" style="text-align:left" >&nbsp;<%=p.getDescription() %></td>
        ...
        <div class="recommend">
            ...
            <%
            	if(al!=null){
	            	...
	            	for(Products ppp : recent){
	            
             %>
                <a href="product.html"><img src=<%=ppp.getImg() %> width="64" height="128"/></a>
                <%
                }
                }
                 %>
